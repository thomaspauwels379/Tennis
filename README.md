...
mvn clean install
```
Then press run in your ide or navigate to the following file and run the main function:
...
mvn clean install
```
Druk daarna op de run button voor java in de ide of navigeer naar de volgende file en run de main functie:
